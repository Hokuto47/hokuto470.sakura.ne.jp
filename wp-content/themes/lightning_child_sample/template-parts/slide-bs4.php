...
?>
		...
		<!-- 画像したにテキストを追加 [template-parts/slide-bs.php]-->
						<div class="toptextbottom" style="z-index:2000;">
									<a>こちらのサイトは「SiteOrigin」というwordpressのプラグインを使用している為<br>簡単な操作のみでカスタマイズをすることができます。
jsの動きにはScrollMagicというjsのプラグインを活用しています。<br>デザインは主にBootstrapを使用しているため編集作業が容易です。<br>全体的なWEBデザインを作成するためにはGIMPで十分です。そしてなんと言ってもWordPressのテーマにはLightningを使用しております。</a>
						</div><!-- END [template-parts/slide-bs.php]-->
